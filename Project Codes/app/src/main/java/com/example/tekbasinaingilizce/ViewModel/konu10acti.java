...
import com.example.tekbasinaingilizce.Model.konu10;
import com.example.tekbasinaingilizce.Model.konu10dinleme;
import com.example.tekbasinaingilizce.Model.konu10okuma;
import com.example.tekbasinaingilizce.Model.konu10video;
...
public class konu10acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new konu10(), "ANLATIM");
        adapter.AddFragment(new konu10video(), "Video");
        adapter.AddFragment(new konu10okuma(), "Anlatim");
        adapter.AddFragment(new konu10dinleme(), "Video");
