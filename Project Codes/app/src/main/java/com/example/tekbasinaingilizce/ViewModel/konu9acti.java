...
import com.example.tekbasinaingilizce.Model.konu9;
import com.example.tekbasinaingilizce.Model.konu9dinleme;
import com.example.tekbasinaingilizce.Model.konu9okuma;
import com.example.tekbasinaingilizce.Model.konu9video;
import com.example.tekbasinaingilizce.R;
import com.google.android.material.appbar.AppBarLayout;
import com.google.android.material.tabs.TabLayout;

public class konu9acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new konu9(), "ANLATIM");
        adapter.AddFragment(new konu9video(), "Video");
        adapter.AddFragment(new konu9okuma(), "Anlatim");
        adapter.AddFragment(new konu9dinleme(), "Video");
