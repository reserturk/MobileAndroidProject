...
import com.example.tekbasinaingilizce.Model.konu3dinleme;
import com.example.tekbasinaingilizce.Model.konu3okuma;
import com.example.tekbasinaingilizce.Model.konu3video;
import com.example.tekbasinaingilizce.R;
import com.google.android.material.appbar.AppBarLayout;
import com.google.android.material.tabs.TabLayout;

public class konu3acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new konu3(), "ANLATIM");
        adapter.AddFragment(new konu3video(), "Video");
        adapter.AddFragment(new konu3okuma(), "Anlatim");
        adapter.AddFragment(new konu3dinleme(), "Video");
