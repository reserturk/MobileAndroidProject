...
import com.example.tekbasinaingilizce.Model.konu7;
import com.example.tekbasinaingilizce.Model.konu7dinleme;
import com.example.tekbasinaingilizce.Model.konu7okuma;
import com.example.tekbasinaingilizce.Model.konu7video;
import com.example.tekbasinaingilizce.R;
import com.google.android.material.appbar.AppBarLayout;
import com.google.android.material.tabs.TabLayout;

public class konu7acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new konu7(), "ANLATIM");
        adapter.AddFragment(new konu7video(), "Video");
        adapter.AddFragment(new konu7okuma(), "Anlatim");
        adapter.AddFragment(new konu7dinleme(), "Video");
