...
import com.example.tekbasinaingilizce.Model.konu6;
import com.example.tekbasinaingilizce.Model.konu6dinleme;
import com.example.tekbasinaingilizce.Model.konu6okuma;
import com.example.tekbasinaingilizce.Model.konu6video;
import com.example.tekbasinaingilizce.R;
import com.google.android.material.appbar.AppBarLayout;
import com.google.android.material.tabs.TabLayout;

public class konu6acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.AddFragment(new konu6(), "ANLATIM");
        adapter.AddFragment(new konu6video(), "Video");
        adapter.AddFragment(new konu6okuma(), "Anlatim");
        adapter.AddFragment(new konu6dinleme(), "Video");
